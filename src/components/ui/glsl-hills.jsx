...
const GLSLHills = ({ width = '100%', height = '100%', cameraZ = 125, planeSize = 256, speed = 0.5, mouseX = 0, mouseY = 0 }) => {
  ...
  useEffect(() => {
          ...
          new THREE.RawShaderMaterial({
            ...
            vertexShader: `
              ...
              void main(void) {
                ...
                vec3 noisePosition = updatePosition + vec3(uMouse.x * 10.0, 0.0, time * -30.0 + uMouse.y * 10.0);
    ...
    const render = () => {
      mouseLerp.current.x += (mouseX - mouseLerp.current.x) * 0.05;
      mouseLerp.current.y += (mouseY - mouseLerp.current.y) * 0.05;
      plane.render(clock.getDelta(), mouseLerp.current);
  ...
  }, [cameraZ, planeSize, speed, mouseX, mouseY]);
